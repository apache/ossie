...
"""Data models for Ataccama ONE catalog metadata and the pieces of Ossie we emit.
...
Ossie semantic model structure (what we produce):
  version, name, description, ai_context, custom_extensions[]
