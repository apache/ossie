...
from ossie_ontology.vendor.palantir.model import DataType, Ontology
from ossie_ontology.vendor.palantir.parser import PalantirOntologyParser, PalantirParser
