...
Building the reactor requires Java 21+ and Maven 3.9.12+ because `ossie-common`
generates the model classes. The resulting Polaris jar is self-contained and
includes `ossie-common`.
